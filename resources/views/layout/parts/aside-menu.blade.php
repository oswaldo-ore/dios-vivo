<div class="menu-item">
    <a class="menu-link" id="menu-estadisticas" href="{{ route('dashboard') }}" title="Estadisticas" data-bs-toggle="tooltip"
...
<div class="menu-item">
    <a class="menu-link" id="menu-registrar-book" href="{{ route('book.index') }}" title="Registrar Ingresos Egresos al libro diario"
...
<div class="menu-item">
    <a class="menu-link"   id="menu-categoria" href="{{ route('category.index') }}"
        title="Gestionar categorias" data-bs-toggle="tooltip"
        data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
...
<div class="menu-item">
    <a class="menu-link"  id="menu-reportes" href="{{ route('report.book.index') }}" title="Registrar Ingresos Egresos al libro diario"
        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Files/Selected-file.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
