<div class="menu-item">
    <a class="menu-link" id="menu-estadisticas" href="{{ route('dashboard.index') }}" title="Estadisticas"
...
<div class="menu-item">
    <a class="menu-link" id="menu-management" href="{{ route('management.index') }}" title="Estadisticas"
        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Shopping/Chart-line1.svg--><svg
        ...
        <span class="menu-title">Estadisticas GESTION</span>
    </a>
</div>
<div class="menu-item">
...
@if (auth()->user()->rol_id == 1 || auth()->user()->rol_id == 2)
    ...
    <div class="menu-item">
        <a class="menu-link" id="monthly-closure-box" href="{{ route('monthly.closure.index') }}"
            title="Registrar Ingresos Egresos al libro diario" data-bs-toggle="tooltip" data-bs-trigger="hover"
            data-bs-dismiss="click" data-bs-placement="right">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-item">
        <a class="menu-link" id="menu-users" href="{{ route('users.index') }}"
            title="Agregar un nuevo administrador" data-bs-toggle="tooltip" data-bs-trigger="hover"
            data-bs-dismiss="click" data-bs-placement="right">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Communication/Group.svg--><svg
