                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="left"
                                                ...
                                                <strong>Saldo Total Rango</strong>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="right" style="padding: 3px !important;">
                                                <strong style="text-transform: capitalize;">
                                                    @if (is_null($lastClosure))
                                                        0
                                                    @else
                                                        {{ $business->currency }}
                                                        {{ number_format($lastClosure->total_cierre, 2, ',', '.') }}
                                                    @endif
                                                </strong>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="left"
                                                style="padding: 3px !important;background-color: rgba(232, 232, 232, 0.3)">
                                                <strong>Saldo Total Actual</strong>
                                            </td>
                                            <td class="right" style="padding: 3px !important;">
                                                <strong style="text-transform: capitalize; color: blue"> {{ $business->currency }}
                                                    {{ number_format($books->totales['total'] + ($lastClosure?$lastClosure->total_cierre:0), 2, ',', '.') }}</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
